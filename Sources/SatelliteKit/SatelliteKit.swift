/*╔══════════════════════════════════════════════════════════════════════════════════════════════════╗
  ...
  ║ Created by Gavin Eadie on Aug05/17 ... Copyright 2016-23 Ramsay Consulting. All rights reserved. ║
  ╚══════════════════════════════════════════════════════════════════════════════════════════════════╝*/
...
public struct SatelliteKit {
    ...
    var staticLibInfo = "~~CopyrightText~~"         // Copyright 2016-23 Ramsay Consulting
